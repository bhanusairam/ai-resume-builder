        ...
        <div className="container" style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          ...
          <div style={{display:"flex",gap:"0.5rem"}}>
            <button
              ...
              style={{background:page==="home"?"linear-gradient(135deg,#a78bfa,#7c3aed)":"transparent",color:"white",border:"1px solid rgba(167,139,250,0.4)",fontSize:"0.85rem",transition:"all 0.3s"}}
            >
              Home
            </button>
            <button
              onClick={()=>setPage("ats")}
              className="btn btn-sm px-3 py-1 rounded-pill fw-semibold"
              style={{background:page==="ats"?"linear-gradient(135deg,#a78bfa,#7c3aed)":"transparent",color:"white",border:"1px solid rgba(167,139,250,0.4)",fontSize:"0.85rem",transition:"all 0.3s"}}
            >
              ATS Score
            </button>
          </div>
