      ...
      <nav className="navbar navbar-expand-lg navbar-dark fixed-top" style={{background:"linear-gradient(135deg,#0f0c29,#302b63,#24243e)",boxShadow:"0 2px 20px rgba(0,0,0,0.3)"}}>
        <div className="container" style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          ...
          <div style={{display:"flex",gap:"0.5rem",alignItems:"center"}}>
            ...
            <button onClick={()=>setPage("ats")} className="btn btn-sm px-3 py-1 rounded-pill fw-semibold" style={{background:page==="ats"?"linear-gradient(135deg,#a78bfa,#7c3aed)":"transparent",color:"white",border:"1px solid rgba(167,139,250,0.4)",fontSize:"0.85rem",transition:"all 0.3s",position:"relative"}}>
              ATS Score
              {formData && page !== "ats" && (
                <span style={{position:"absolute",top:"-4px",right:"-4px",width:"8px",height:"8px",borderRadius:"50%",background:"#22c55e",border:"1px solid #0f0c29"}}></span>
              )}
            </button>
          </div>
        </div>
